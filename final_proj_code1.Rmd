...
w3 <- lm(sum.porn ~ in_ram + days_in_eid, data=world_interest)
w4 <- lm(sum.porn ~ days_in_ram + days_in_eid, data=world_interest)
...
stargazer(ma, mb, m1, summary = FALSE, type = "text", title = "Changes in Sex and Porn Related Search Values Over Ramadan in 5 Muslim-Majority Countries", dep.var.labels = "Mean values for 'sex' and 'porn' hits by Week",  covariate.labels = c("Days in Ram", "Presence of Ram (0 or 1)", "Presence of Eid (0 or 1)"))
