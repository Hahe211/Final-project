...
#year controls dont make a difference in p values, sd, or coeff so I'm back to removing them - probably because data set is already normalized for year
m1 <- lm(hits ~ in_ram + geo, data=D1_interest)
m2 <- lm(hits ~ days_in_ram + geo, data=D1_interest)


#global data - no sig impact detected
...
reg_table <- stargazer(ma, mb, m1, m2, m3, m4, type="text")
