...
# 
# kable(reg_table)
#my_stargazer <- capture.output(stargazer(ma, mb, m1, m2, type = "html", dep.var.labels = "Country level porn hits"))

```


This regression table output demonstrates how Ramadan causes a sigificant decrease in sex and porn related searches. 
```{r, echo = FALSE, message = FALSE, warning= FALSE, results = "asis"}
#use results = asis in the caption to make sure the table prints properly


stargazer(ma, mb, m1, m2, summary = FALSE, type = "text", dep.var.labels = "Country level porn hits")

#my_stargazer
#and in kable
#kable(x = my_stargazer)
```
