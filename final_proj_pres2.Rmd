...
The dependent variable represents the mean popularity of the two most common porn-related search terms for Egypt, Tunisia, Libya, Arab Emirates, Saudi Arabia, Iran, Afghanistan, Jordan, Pakistan, Malaysia from Jan 5, 2014 through December 12, 2018. There are 2827 observations, each corresponding to a value for porn search volume in a given week in a given country. I began the search after 2014 since google trends offers a convenient option to download weekly data for the past 5 years. In future studies, it would be possible to include earlier years. 
...
The presence of Ramadan is associated with a nine-percentage point  decrease in weekly porn searches. As seen in Regression 4, the week before Ramadan also results in a two-percentage point decrease in searches. However, in the week following, in which Eid al-Futr occurs, there is a rebound effect of an increase in pornography searches by over 15 percentage points. This increase is greater in magnitude than the decrease (regressions 3 and 4). These results are significant (p < .01) and include controls for year and country. 
...
p + scale_color_discrete(labels = c("After Ramadan", "Rest of Year", "Ramadan")) +
        ...
        labs(title = "Changes By Country in Median Weekly Porn Search Values",
...
Here is series of individual country graph to think about the variation between countries - some countries exhibit more signficant changes over Ramadan than others! Pakistan tops the list with a thirty percent decrease while Iran is at the bottom with only a thirteen percent decrease. That is a big difference. 
...
We know that Muslims make up [twenty-four percent of the global population](http://www.pewresearch.org/fact-tank/2017/04/06/why-muslims-are-the-worlds-fastest-growing-religious-group/). Does the presence of Ramadan also have an impact on global pornography searching?

To answer this I pull global google search data from from 2014-2018. The data shows that Ramadan is associated with a one and a half percentage point decrease in global searches for “sex” and “porn” at ten-percent significance level, in a given year.

The Muslim population has been projected to increase to constitute [thirty-two percent of the global population]((http://www.pewresearch.org/fact-tank/2017/04/06/why-muslims-are-the-worlds-fastest-growing-religious-group/) by 2060 so their influence on Google Trends might increase over time.
