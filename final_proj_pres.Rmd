...
Understanding values for sex and porn searches:
...
"Days in Ramadan" is a continuous variable with values zero through seven, designating the number of days in a a given week which include. "Presence of Ramadan" is a binary variable with values of one or zero based on the presence of absence of Ramadan.
...
###Did I pick the right search terms?
```{r, echo = FALSE, message = FALSE, warning= FALSE, cache = TRUE}
