...
There has been conflicting research connecting pornography searching to religious observance and holidays. A selection of studies coducted at the individual level show that religious individuals report lower levels of porn consumption. [Kyler Rasmussen, Alex Bierman. (2016)](https://doi.org/10.1016/j.adolescence.2016.03.017.) However, research relying on non-self reported data from web subscriptions and internet search values suggests the opposite. 

A state level study in the US demonstrates that higher percentages of practicing Christians in a state predict higher frequencies of porn searching. [(Andrew L. Whitehead & Samuel L. Perry 2018)](https://www.ncbi.nlm.nih.gov/pubmed/28276941) A similar study showed that regions where more people report regularly attending religious services, purchased the same total level of porn but a smaller portion of subscriptions begin on Sunday. [Edelman, B. (2009)](http://www.benedelman.org/publications/redlightstates.pdf)

Finally, [pornhub](https://www.pornhub.com/insights/christmas-holiday-searches) publishes subscription statistics from the Christmas holiday season. They show that traffic changes on Christmas Day vary widely by country. In some countries such as Austrialia, the UK, and the Italy there is a decrease in traffic by over 20%. However, in Japan, India and Russia there is the opposite effect of an increase in traffic running from 2% to 13%.  
...
The dependent variable represents the mean popularity of two porn-related search terms for Egypt, Tunisia, Libya, Arab Emirates, Saudi Arabia, Iran, Afghanistan, Jordan, Pakistan, Malaysia from Jan 5, 2014 through December 12, 2018. I begin the search after 2014 since google trends offers a convenient option to download weekly data for the past 5 years. If one downloads data from earilier, the data is measured in monthly instead of weekly units, which wasn’t fine-grained enough for my purposes. 
Since I was interested in change over time and not total volume, I tested and selected my terms on a country basis. For each country, I choose the two highest volume queries from a list of twenty. In all but Iran and Afghanistan, the highest volume porn searches were for “sex” and “porn” instead of the Arabic language terms I tried. This speaks to the international nature of the pornography industry.  In Iran and Afghanistan,  سکس  was searched more popularly than  “porn”
I tested Arabic and Farsi search terms from lists in the following two sources [1](https://productforums.google.com/forum/#!msg/websearch/0_kNuK17P8o/TjMBPHhOuysJ),
[2](https://opennet.net/sites/opennet.net/files/bing_arabiancountries.pdf)
